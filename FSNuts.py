...
# NOTE!! this command is left for backward compatibility, Screw_Maker.py
# nuts are now used.
...
NutDiamCodes = ['Auto', 'M1.6', 'M2', 'M2.5', 'M3', 'M3.5', 'M4', 'M5',
                'M6', 'M8', 'M10', 'M12', 'M14', 'M16', 'M20', 'M24', 'M30', 'M36']
MHexNutTable = {
    #         S,    M,    d
    'M1.6': (3.2,  1.3,  1.25),
    'M2':  (4.0,  1.6,  1.6),
...
class FSHexNutObject(FSBaseObject):
    ...
    def __init__(self, obj, attachTo):
        ...
        obj.addProperty("App::PropertyEnumeration", "diameter", "Parameters",
                        "Press nut thread diameter").diameter = NutDiamCodes
        obj.Proxy = self
