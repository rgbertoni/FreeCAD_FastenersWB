...
standard_diameters = {
    ...
    'DIN7984': ('M3',   'M24'),
    # ISO 2009 Slotted countersunk flat head screws
    'ISO2009': ('M1.6', 'M10'),
    ...
    # ISO 7048 Cross-recessed cheese head screws with type H cross recess
    'ISO7048': ('M2.5', 'M8'),
    'ISO7380-1': ('M3',  'M16'),  # ISO 7380 Hexagon socket button head screws
    # ISO 7380 Hexagon socket button head screws with collar
    'ISO7380-2': ('M3',  'M16'),
    # DIN 967 Cross recessed pan head screws with collar
    'DIN967': ('M3',   'M8'),
    ...
    'ISO14580': ('M2',   'M10'),
    # ISO 14581 Hexalobular socket countersunk flat head screws (to do!!)
    'ISO14581': ('M2',   'M10'),
    # ISO 14582 Hexalobular socket countersunk head screws, high head
    'ISO14582': ('M3',   'M10'),
    ...
    # ISO 4035 Hexagon thin nuts, unchamfered, todo no function coded
    'ISO4036': ('M1.6', 'M10'),
...
iso4017head = {
    ...
    # dw not in class A, e not in class A
    'M30':   (3.50, 0.4, 42.8, 50.9, 18.7, 1.0,  46.0),
    '(M33)': (3.50, 0.4, 46.6, 55.4, 21.0, 1.0,  50.0),
    # dw not in class A, e not in class A
    'M36':   (4.00, 0.4, 51.2, 61.0, 22.5, 1.0,  55.0),
...
iso4014head = {
    ...
    # dw not in class A, e not in class A
    'M30':   (3.50,  66.0,  72.0,  85.0, 0.4, 42.8, 50.9, 18.7, 1.0, 46.0),
...
def getLength(obj=None, typeFst=None, diameter=None):
    leng = None
    if obj:
        typeFst = obj.type
        ...
        if hasattr(obj, "length"):
            leng = obj.length
    if typeFst == "F436":
        leng = ScrewMaker.screwTables[typeFst][1][diameter][3]
    if typeFst == "A563H":
        leng = ScrewMaker.screwTables[typeFst][1][diameter][5]
    if typeFst == "WallPlugS":
        leng = ScrewMaker.screwTables[typeFst][1][diameter][3]
    return leng
...
class Ui_ScrewMaker(object):
    ...
    def setupUi(self, ScrewMaker):
        ...
        ScrewMaker.setLocale(QtCore.QLocale(
        ...
        QtCore.QObject.connect(self.ScrewType, QtCore.SIGNAL(
            _fromUtf8("currentIndexChanged(int)")), self.guiCheck_Data)
        QtCore.QObject.connect(self.CreateButton, QtCore.SIGNAL(
            _fromUtf8("pressed()")), self.guiCreateScrew)
        QtCore.QObject.connect(self.NominalDiameter, QtCore.SIGNAL(
            _fromUtf8("currentIndexChanged(int)")), self.guiCheck_Data)
        QtCore.QObject.connect(self.NominalLength, QtCore.SIGNAL(
            _fromUtf8("currentIndexChanged(int)")), self.guiCheck_Data)
        QtCore.QMetaObject.connectSlotsByName(ScrewMaker)

    def retranslateUi(self, ScrewMaker):
        ScrewMaker.setWindowTitle(_translate(
            "ScrewMaker", "Screw-Maker 2.0", None))
        self.ScrewTypeLabel.setText(_translate(
            "ScrewMaker", "Type of Screw", None))
        self.NomDiaLabel.setText(_translate(
            "ScrewMaker", "Nominal\nDiameter", None))
        self.NomLenLabel.setText(_translate(
            "ScrewMaker", "Nominal\nLength", None))
        self.UserLenLabel.setText(_translate(
            "ScrewMaker", "User length \nfor screw-tap", None))
        self.CommentLabel.setText(_translate(
            "ScrewMaker", "Values in brackets are not recommended!", None))
        self.ScrewType.setItemText(0, _translate(
            "ScrewMaker", "ISO4017: Hexagon head screws", None))
        self.ScrewType.setItemText(1, _translate(
            "ScrewMaker", "ISO4014: Hexagon head bolts", None))
        self.ScrewType.setItemText(2, _translate(
            "ScrewMaker", "EN1662: Hexagon bolts with flange, small\n   series", None))
        self.ScrewType.setItemText(3, _translate(
            "ScrewMaker", "EN1665: Hexagon bolts with flange, heavy\n   series", None))
        self.ScrewType.setItemText(4, _translate(
            "ScrewMaker", "ISO4762: Hexagon socket head cap screws", None))
        self.ScrewType.setItemText(5, _translate(
            "ScrewMaker", "ISO7380-1: Hexagon socket button head\n    screws", None))
        self.ScrewType.setItemText(6, _translate(
            "ScrewMaker", "ISO7380-2: Hexagon socket button head\n    screws with collar", None))
        self.ScrewType.setItemText(7, _translate(
            "ScrewMaker", "DIN967: Cross recessed pan head screws\n    with collar", None))
        self.ScrewType.setItemText(8, _translate(
            "ScrewMaker", "ISO10642: Hexagon socket countersunk \n    head screws", None))
        self.ScrewType.setItemText(9, _translate(
            "ScrewMaker", "ISO2009: Slotted countersunk flat head\n    screws", None))
        self.ScrewType.setItemText(10, _translate(
            "ScrewMaker", "ISO2010: Slotted raised countersunk head\n   screws", None))
        self.ScrewType.setItemText(11, _translate(
            "ScrewMaker", "ISO1207: Slotted cheese head screws", None))
        self.ScrewType.setItemText(12, _translate(
            "ScrewMaker", "ISO1580: Slotted pan head screws", None))
        self.ScrewType.setItemText(13, _translate(
            "ScrewMaker", "ISO7045: Pan head screws, type H cross recess", None))
        self.ScrewType.setItemText(14, _translate(
            "ScrewMaker", "ISO7046: Countersunk flat head screws\n    H cross recess", None))
        self.ScrewType.setItemText(15, _translate(
            "ScrewMaker", "ISO7047: Raised countersunk head screws\n    H cross recess", None))
        self.ScrewType.setItemText(16, _translate(
            "ScrewMaker", "ISO7048: Cheese head screws type H cross recess", None))
        self.ScrewType.setItemText(17, _translate(
            "ScrewMaker", "ISO14579: Hexalobular socket head cap screws", None))
        self.ScrewType.setItemText(18, _translate(
            "ScrewMaker", "ISO14580: Hexalobular socket cheese head\n   screws", None))
        self.ScrewType.setItemText(19, _translate(
            "ScrewMaker", "ISO14583: Hexalobular socket pan head screws", None))
        self.ScrewType.setItemText(20, _translate(
            "ScrewMaker", "ISO14582: Hexalobular socket countersunk\n    head screws, high head", None))
        self.ScrewType.setItemText(21, _translate(
            "ScrewMaker", "ISO14584: Hexalobular socket raised\n    countersunk head screws", None))
        self.ScrewType.setItemText(22, _translate(
            "ScrewMaker", "ISO7089: Plain washers - Normal series", None))
        self.ScrewType.setItemText(23, _translate(
            "ScrewMaker", "ISO7090: Plain washers, chamfered - Normal series", None))
        self.ScrewType.setItemText(24, _translate(
            "ScrewMaker", "ISO7092: Plain washers - Small series", None))
        self.ScrewType.setItemText(25, _translate(
            "ScrewMaker", "ISO7093-1: Plain washer - Large series", None))
        self.ScrewType.setItemText(26, _translate(
            "ScrewMaker", "ISO7094: Plain washers - Extra large series", None))
        self.ScrewType.setItemText(27, _translate(
            "ScrewMaker", "ISO4032: Hexagon nuts, Style 1", None))
        self.ScrewType.setItemText(28, _translate(
            "ScrewMaker", "ISO4033: Hexagon nuts, Style 2", None))
        self.ScrewType.setItemText(29, _translate(
            "ScrewMaker", "ISO4035: Hexagon thin nuts, chamfered", None))
        self.ScrewType.setItemText(30, _translate(
            "ScrewMaker", "EN1661: Hexagon nuts with flange", None))
        self.ScrewType.setItemText(31, _translate(
            "ScrewMaker", "ScrewTap: ISO Screw-Tap", None))
        self.ScrewType.setItemText(32, _translate(
            "ScrewMaker", "DIN7984: Hexagon socket head cap screws with low head", None))

        self.NominalDiameter.setItemText(
            0, _translate("ScrewMaker", "M1.6", None))
        self.NominalDiameter.setItemText(
            1, _translate("ScrewMaker", "M2", None))
        self.NominalDiameter.setItemText(
            2, _translate("ScrewMaker", "M2.5", None))
        self.NominalDiameter.setItemText(
            3, _translate("ScrewMaker", "M3", None))
        self.NominalDiameter.setItemText(
            4, _translate("ScrewMaker", "(M3.5)", None))
        self.NominalDiameter.setItemText(
            5, _translate("ScrewMaker", "M4", None))
        self.NominalDiameter.setItemText(
            6, _translate("ScrewMaker", "M5", None))
        self.NominalDiameter.setItemText(
            7, _translate("ScrewMaker", "M6", None))
        self.NominalDiameter.setItemText(
            8, _translate("ScrewMaker", "M8", None))
        self.NominalDiameter.setItemText(
            9, _translate("ScrewMaker", "M10", None))
        self.NominalDiameter.setItemText(
            10, _translate("ScrewMaker", "M12", None))
        self.NominalDiameter.setItemText(
            11, _translate("ScrewMaker", "(M14)", None))
        self.NominalDiameter.setItemText(
            12, _translate("ScrewMaker", "M16", None))
        self.NominalDiameter.setItemText(
            13, _translate("ScrewMaker", "(M18)", None))
        self.NominalDiameter.setItemText(
            14, _translate("ScrewMaker", "M20", None))
        self.NominalDiameter.setItemText(
            15, _translate("ScrewMaker", "(M22)", None))
        self.NominalDiameter.setItemText(
            16, _translate("ScrewMaker", "M24", None))
        self.NominalDiameter.setItemText(
            17, _translate("ScrewMaker", "(M27)", None))
        self.NominalDiameter.setItemText(
            18, _translate("ScrewMaker", "M30", None))
        self.NominalDiameter.setItemText(
            19, _translate("ScrewMaker", "M36", None))
        self.NominalDiameter.setItemText(
            20, _translate("ScrewMaker", "(M33)", None))
        self.NominalDiameter.setItemText(
            21, _translate("ScrewMaker", "M42", None))
        self.NominalDiameter.setItemText(
            22, _translate("ScrewMaker", "(M45)", None))
        self.NominalDiameter.setItemText(
            23, _translate("ScrewMaker", "M48", None))
        self.NominalDiameter.setItemText(
            24, _translate("ScrewMaker", "(M52)", None))
        self.NominalDiameter.setItemText(
            25, _translate("ScrewMaker", "M54", None))
        self.NominalDiameter.setItemText(
            26, _translate("ScrewMaker", "(M60)", None))
        self.NominalDiameter.setItemText(
            27, _translate("ScrewMaker", "M64", None))

        self.NominalLength.setItemText(0, _translate("ScrewMaker", "2", None))
        self.NominalLength.setItemText(
            1, _translate("ScrewMaker", "2.5", None))
        ...
        self.NominalLength.setItemText(
            10, _translate("ScrewMaker", "20", None))
        self.NominalLength.setItemText(
            11, _translate("ScrewMaker", "25", None))
        self.NominalLength.setItemText(
            12, _translate("ScrewMaker", "30", None))
        self.NominalLength.setItemText(
            13, _translate("ScrewMaker", "35", None))
        self.NominalLength.setItemText(
            14, _translate("ScrewMaker", "40", None))
        self.NominalLength.setItemText(
            15, _translate("ScrewMaker", "45", None))
        self.NominalLength.setItemText(
            16, _translate("ScrewMaker", "50", None))
        self.NominalLength.setItemText(
            17, _translate("ScrewMaker", "55", None))
        self.NominalLength.setItemText(
            18, _translate("ScrewMaker", "60", None))
        self.NominalLength.setItemText(
            19, _translate("ScrewMaker", "65", None))
        self.NominalLength.setItemText(
            20, _translate("ScrewMaker", "70", None))
        self.NominalLength.setItemText(
            21, _translate("ScrewMaker", "80", None))
        self.NominalLength.setItemText(
            22, _translate("ScrewMaker", "90", None))
        self.NominalLength.setItemText(
            23, _translate("ScrewMaker", "100", None))
        self.NominalLength.setItemText(
            24, _translate("ScrewMaker", "110", None))
        self.NominalLength.setItemText(
            25, _translate("ScrewMaker", "120", None))
        self.NominalLength.setItemText(
            26, _translate("ScrewMaker", "130", None))
        self.NominalLength.setItemText(
            27, _translate("ScrewMaker", "140", None))
        self.NominalLength.setItemText(
            28, _translate("ScrewMaker", "150", None))
        self.NominalLength.setItemText(
            29, _translate("ScrewMaker", "160", None))
        self.NominalLength.setItemText(
            30, _translate("ScrewMaker", "180", None))
        self.NominalLength.setItemText(
            31, _translate("ScrewMaker", "200", None))
        self.NominalLength.setItemText(
            32, _translate("ScrewMaker", "220", None))
        self.NominalLength.setItemText(
            33, _translate("ScrewMaker", "240", None))
        self.NominalLength.setItemText(
            34, _translate("ScrewMaker", "260", None))
        self.NominalLength.setItemText(
            35, _translate("ScrewMaker", "280", None))
        self.NominalLength.setItemText(
            36, _translate("ScrewMaker", "300", None))
        self.NominalLength.setItemText(
            37, _translate("ScrewMaker", "320", None))
        self.NominalLength.setItemText(
            38, _translate("ScrewMaker", "340", None))
        self.NominalLength.setItemText(
            39, _translate("ScrewMaker", "360", None))
        self.NominalLength.setItemText(
            40, _translate("ScrewMaker", "380", None))
        self.NominalLength.setItemText(
            41, _translate("ScrewMaker", "400", None))
        self.NominalLength.setItemText(
            42, _translate("ScrewMaker", "420", None))
        self.NominalLength.setItemText(
            43, _translate("ScrewMaker", "440", None))
        self.NominalLength.setItemText(
            44, _translate("ScrewMaker", "460", None))
        self.NominalLength.setItemText(
            45, _translate("ScrewMaker", "480", None))
        self.NominalLength.setItemText(
            46, _translate("ScrewMaker", "500", None))
        self.NominalLength.setItemText(
            47, _translate("ScrewMaker", "User", None))
        #self.UserLen.setItemText(0, _translate("ScrewMaker", "regular pitch", None))
        self.SimpleScrew.setText(_translate(
            "ScrewMaker", "Simple Screw (no thread at all!)", None))
        self.SymbolThread.setText(_translate(
            "ScrewMaker", "Symbol Thread (not implemented yet)", None))
        self.RealThread.setText(_translate(
            "ScrewMaker", "Real Thread (takes time, memory intensive)\nMay not work for all screws!", None))
        self.MessageLabel.setText(_translate(
            "ScrewMaker", "Select your screw type", None))
        self.MessageLabel.setProperty("Errortext", _translate(
            "ScrewMaker", "Combination not implemented", None))
        self.MessageLabel.setProperty("OK_text", _translate(
            "ScrewMaker", "Screw is made", None))
    ...
    def guiCheck_Data(self):
        ...
        M_text, self.ScrewAvailable = self.theScrew.check_Data(
            ST_text, ND_text, NL_text)
    ...
    def guiCreateScrew(self):
        ...
        myObj = self.theScrew.createScrew(
            ST_text, ND_text, NL_text, threadType)
...
class Screw(object):
    ...
    def check_Data(self, ST_text, ND_text, NL_text):
        ...
        if ND_text not in table:
            ...
            M_text = ST_text + ' has diameters from ' + ND_min + \
                ' to ' + ND_max + ' and not ' + ND_text + '!'
            self.objAvailable = False
            # set scew not ok
        else:
            if Type_text == 'Screw':
                ...
                if NL_text == 'User':
                    ...
                    if (NL_text_float < NL_min_float)or(NL_text_float > NL_max_float)or(NL_text not in tab_len):
                        ...
                        M_text = ST_text + '-' + ND_text + ' has lengths from ' + \
                            NL_min + ' to ' + NL_max + ' and not ' + NL_text + '!'
                        self.objAvailable = False
                        # set screw not ok
                    else:
                        if '(' in ND_text:
                ...
                if not (Type_text == 'Screw-Tap'):
                    ...
                    if NL_text == 'User':
                        ...
                        if '(' in ND_text:
                            ND_text = ND_text.lstrip('(').rstrip(')')
                        M_text = ST_text + '-' + ND_text + ' with ' + \
                            NL_text + 'mm length is in library available! '
                        self.objAvailable = True
                        # set screwTap ok
    ...
    def createScrew(self, ST_text, ND_text, NL_text, threadType, shapeOnly=False):
        ...
        if self.objAvailable:
            try:
                ...
                # print "Error! nom_dia and length values must be valid
                # numbers!"
    ...
    def moveScrew(self, ScrewObj_m):
        ...
        if (mylist.__len__() == 1):
            ...
            if (Axis1 != None):
                ...
                # Berechnung der Quaternionen-Elemente
                normvec.multiply(-sin_res)
                ...
                neuPlatz.Rotation = pl.Rotation.multiply(
    ...
    def makeIso7089(self, SType='ISO7089', ThreadType='M6'):
        ...
        head = aFace.revolve(Base.Vector(0.0, 0.0, 0.0),
                             Base.Vector(0.0, 0.0, 1.0), 360)
    ...
    # make ISO 1580 Pan head slotted screw (Code is nearly identical to
    # iso1207)
    def makeSlottedScrew(self, SType='ISO1580', ThreadType='M6', l=25.0):
        ...
        if SType == 'ISO1580':
            ...
            P, a, b, dk_max, da, k, n_min, r, rf, t_min, x = iso1580def[
                ThreadType]
            ...
            Pnt4 = Base.Vector(fillet_center_x + r_fil * math.cos(beta),
                               0.0, fillet_center_z + r_fil * math.sin(beta))
            Pnt5 = Base.Vector(dk_max / 2.0, 0.0, 0.0)
            # start of fillet between head and shank
            Pnt6 = Base.Vector(dia / 2.0 + r, 0.0, 0.0)
            Pnt7 = Base.Vector(dia / 2.0 + r - r * sqrt2_,
                               0.0, -r + r * sqrt2_)  # arc-point of fillet
            # Pnt8 = Base.Vector(dia/2.0,0.0,-r)        # end of fillet
            PntR = Base.Vector(dia / 2.0, 0.0, -r)        # end of fillet
            # helper point for real thread
            PntT0 = Base.Vector(0.0, 0.0, -r)
        ...
        if (SType == 'ISO2009') or (SType == 'ISO2010'):
            P, a, b, dk_theo, dk_mean, k, n_min, r, t_mean, x = iso2009def[
                ThreadType]
            dk_max = dk_theo
            t_min = t_mean
            ...
            Pnt3 = Base.Vector(dia / 2.0 + r - r * math.cos(rad45),
                               0.0, -k - rtan + r * math.sin(rad45))
            # Arc-points
            Pnt4 = Base.Vector(dia / 2.0 + r - r * (math.cos(rad225)),
                               0.0, -k - rtan + r * math.sin(rad225))
            PntR = Base.Vector(dia / 2.0, 0.0, -k - rtan)
            #PntA = Base.Vector(dia/2.0,0.0,-a_point)
            # helper point for real thread
            PntT0 = Base.Vector(0.0, 0.0, -k - rtan)
    ...
    def makeIso7045(self, SType='ISO7045', ThreadType='M6', l=25.0):
        ...
        # start of fillet between head and shank
        Pnt4 = Base.Vector(dia / 2.0 + r, 0.0, 0.0)
        Pnt5 = Base.Vector(dia / 2.0 + r - r * sqrt2_, 0.0, -
                           r + r * sqrt2_)  # arc-point of fillet
        ...
        hWire = Part.Wire([edge1, edgeH1, edgeH2, edgeH3]
                          )  # Cutter for recess-Shell
        hFace = Part.Face(hWire)
        hCut = hFace.revolve(Base.Vector(0.0, 0.0, 0.0),
                             Base.Vector(0.0, 0.0, 1.0), 360)
        # Part.show(hWire)

        headShell = aWire.revolve(Base.Vector(
            0.0, 0.0, 0.0), Base.Vector(0.0, 0.0, 1.0), 360)
    ...
    '''
        ...
        if (SType == 'ISO1207') or (SType == 'ISO14580'):
            P, a, b, dk, dk_mean, da, k, n_min, r, t_min, x = iso1207def[
                ThreadType]
        if SType == 'ISO7048':
            P, a, b, dk, dk_mean, da, k, r, x, cT, mH, mZ = iso7048def[
                ThreadType]
        if (SType == 'ISO14580'):
        ...
        # start of fillet between head and shank
        Pnt6 = Base.Vector(dia / 2.0 + r, 0.0, 0.0)
        Pnt7 = Base.Vector(dia / 2.0 + r - r * sqrt2_, 0.0, -
                           r + r * sqrt2_)  # arc-point of fillet
        Pnt8 = Base.Vector(dia / 2.0, 0.0, -r)        # end of fillet
        ...
        if (SType == 'ISO14580'):
            ...
            # Center Point for flat countersunk
            Pnt0 = Base.Vector(0.0, 0.0, k - A / 8.0)
            PntFlat = Base.Vector(A / 8.0, 0.0, k - A /
                                  8.0)  # End of flat part
        ...
        if SType == 'ISO1207':
            ...
            if self.rThread:
                ...
                rthread = self.makeShellthread(
                    dia, P, halfturns, False, offSet)
                rthread.translate(Base.Vector(0.0, 0.0, -a_point - 2.0 * P))
                for threadFace in rthread.Faces:
            ...
            #aFace =Part.Face(aWire)
            headShell = aWire.revolve(Base.Vector(
                0.0, 0.0, 0.0), Base.Vector(0.0, 0.0, 1.0), 360.0)
            #FreeCAD.Console.PrintMessage("der Kopf mit revolve: " + str(dia) + "\n")
            ...
            if (SType == 'ISO14580'):
                ...
                # Cutter for recess-Shell
                hWire = Part.Wire([edgeCham1, edgeH1, edgeH2, edgeH3])
                hFace = Part.Face(hWire)
                hCut = hFace.revolve(Base.Vector(
                    0.0, 0.0, 0.0), Base.Vector(0.0, 0.0, 1.0), 360)
                # Part.show(hWire)
    ...
    def makeFromString(self, type, diameter, length=""):
        ...
        if length:
            ...
            sep = ""
            length = ""
        file = dirShapes + "\\" + type + "_" + diameter + sep + length + ".brep"
    ...
    def makeIso4017_2(self, SType='ISO4017', ThreadType='M6', l=40.0):
        ...
        # start of fillet between head and shank
        Pnt7 = Base.Vector(dia / 2.0 + r, 0.0, 0.0)
        Pnt8 = Base.Vector(dia / 2.0 + r - r * sqrt2_, 0.0, -
                           r + r * sqrt2_)  # arc-point of fillet
    ...
    def makeEN1662_2(self, SType='EN1662', ThreadType='M8', l=25.0):
        ...
        #FreeCAD.Console.PrintMessage("der Kopf mit l: " + str(l) + "\n")
        if SType == 'EN1662':
            P, b0, b1, b2, b3, c, dc, dw, e, k, kw, f, r1, s = en1662def[
                ThreadType]
        else:
            P, b0, b1, b2, b3, c, dc, dw, e, k, kw, f, r1, s = en1665def[
                ThreadType]
        if l < b0:
            b = l - 2 * P
        else:
        ...
        cham = s * (2.0 / math.sqrt(3.0) - 1.0) * \
            math.sin(math.radians(25))  # needed for chamfer at head top
        ...
        # height of flange at center
        hF = arc1_z + (arc1_x - s / 2.0) * tan_beta

        kmean = arc1_z + (arc1_x - s / math.sqrt(3.0)) * \
            tan_beta + kw * 1.1 + cham
        #kmean = k * 0.95
        ...
        PntH1a = Base.Vector(s / 2.0 * 0.8 - r1 / 2.0 + r1 / 2.0 *
                             sqrt2_, 0.0, kmean * 0.9 + r1 / 2.0 - r1 / 2.0 * sqrt2_)
        PntH1b = Base.Vector(s / 2.0 * 0.8, 0.0, kmean * 0.9 + r1 / 2.0)
        PntH2 = Base.Vector(s / 2.0 * 0.8, 0.0, kmean - r1)
        PntH2a = Base.Vector(s / 2.0 * 0.8 + r1 - r1 *
                             sqrt2_, 0.0, kmean - r1 + r1 * sqrt2_)
        ...
        topShell = hWire.revolve(Base.Vector(
            0.0, 0.0, 0.0), Base.Vector(0.0, 0.0, 1.0), 360)
        # Part.show(hWire)
        # Part.show(topShell)
        ...
        PntC4 = Base.Vector(s / math.sqrt(3.0) + chamHori,
                            0.0, kmean - cham - cham)  # s/math.sqrt(3.0)
        ...
        chamCut = cFace.revolve(Base.Vector(
            0.0, 0.0, 0.0), Base.Vector(0.0, 0.0, 1.0), 360)
        # Part.show(cWire)
        # Part.show(chamCut)
        ...
        # start of fillet between head and shank
        Pnt5 = Base.Vector(dia / 2.0 + r1, 0.0, 0.0)
        Pnt6 = Base.Vector(dia / 2.0 + r1 - r1 * sqrt2_,
                           0.0, -r1 + r1 * sqrt2_)  # arc-point of fillet
        ...
        hex2Cut = HCFace.revolve(Base.Vector(
            0.0, 0.0, 0.0), Base.Vector(0.0, 0.0, 1.0), 360)
        ...
        if self.rThread:
            ...
            if a_point <= r1:
                edgeB1 = Part.makeLine(Pnt7, PntB1)
                aWire = Part.Wire(
                    [edge2, edge3, edge4, edge5, edgeB1, edgeB2, edgeB3])
                boltIndex = 7
            else:
                edgeB1 = Part.makeLine(Pnt8, PntB1)
    ...
    def makeIso7046(self, SType='ISO7046', ThreadType='M6', l=25.0):
        ...
        if (SType == 'ISO10642'):
            P, b, dk_theo, dk_mean, da, ds_min, e, k, r, s_mean, t, w = iso10642def[
                ThreadType]
        ...
        if (SType == 'ISO14582'):
            P, a, b, dk_theo, dk_mean, k, r, tt, A, t_mean = iso14582def[
                ThreadType]
            ePrax = A / 2.0 / 0.99

        if (SType == 'ISO14584'):
            P, b, dk_theo, dk_mean, f, k, r, rf, x, tt, A, t_mean = iso14584def[
                ThreadType]
            ePrax = A / 2.0 / 0.99
            # Lengths and angles for calculation of head rounding
            beta = math.asin(dk_mean / 2.0 / rf)   # angle of head edge
            tan_beta = math.tan(beta)
            # Center Top Edge = center for rf
            ctp = - (dk_mean / 2.0) / tan_beta
            # angle of head edge at start of recess
            betaA = math.asin(ePrax / rf)
        ...
        if (SType == 'ISO10642') or (SType == 'ISO14582'):
            ...
            if (SType == 'ISO14582'):
                recess, recessShell = self.makeIso10664_3(
                    tt, t_mean, 0.0)  # hexalobular recess
            ...
            if (SType == 'ISO14584'):  # make raised head rounding with chamfer
                ...
                PntH1 = Base.Vector(ePrax, 0.0, ht + k)
                recess, recessShell = self.makeIso10664_3(
                    tt, t_mean, ht)  # hexalobular recess
        ...
        if self.rThread:
            ...
            if a_point <= (k + rtan):
                ...
                aWire = Part.Wire(
                    [edge2, edge3, edgeArc, edge6, edgeB0, edgeB1])
        ...
        if (SType == 'ISO7046') or (SType == 'ISO14582'):
            ...
            # Cutter for recess-Shell
            hWire = Part.Wire([edge1, edgeH3, edgeH2, edgeH1])
        ...
        if (SType == 'ISO10642') or (SType == 'ISO14582'):
            if self.rThread:
                if (dia < 3.0) or (dia > 5.0):
                    # if True:
                    rthread = self.makeShellthread(
                        dia, P, halfturns, True, offSet)
                    rthread.translate(Base.Vector(
                        0.0, 0.0, -a_point - 2.0 * P))
                    #head = head.fuse(rthread)
                    # Part.show(rthread)
                    for threadFace in rthread.Faces:
                        headFaces.append(threadFace)
    ...
    def makeIso4762(self, SType='ISO4762', ThreadType='M6', l=25.0):
        ...
        #FreeCAD.Console.PrintMessage("der Kopf mit iso r: " + str(r) + "\n")
        if SType == 'ISO14579':
            P, b, dk_max, da, ds_mean, e, lf, k, r, s_mean, t, v, dw, w = iso4762def[
                ThreadType]
            ...
            P, b, dk_max, da, ds_min, e, k, r, s_mean, t, v, dw = din7984def[
                ThreadType]
            e_cham = 2.0 * s_mean / math.sqrt(3.0)
            # Head Points 45° countersunk
            # Center Point for countersunk
            Pnt0 = Base.Vector(0.0, 0.0, k - e_cham / 1.99 / 2.0)
            PntFlat = Base.Vector(e_cham / 1.99 / 2.0, 0.0,
                                  k - e_cham / 1.99 / 2.0)  # End of flat part
            # countersunk edge at head
            Pnt1 = Base.Vector(e_cham / 1.99, 0.0, k)
            edgeCham0 = Part.makeLine(Pnt0, PntFlat)
            edgeCham1 = Part.makeLine(PntFlat, Pnt1)
            edge1 = Part.Wire([edgeCham0, edgeCham1])
    ...
    '''
        ...
        Pnt3 = Base.Vector(dk_max / 2.0 - v + v * sqrt2_, 0.0,
                           k - v + v * sqrt2_)  # arc-point of fillet
        Pnt4 = Base.Vector(dk_max / 2.0, 0.0, k - v)  # end of fillet
        # we have a chamfer here
        Pnt5 = Base.Vector(dk_max / 2.0, 0.0, (dk_max - dw) / 2.0)
    ...
    def makeIso7380(self, SType='ISO7380-1', ThreadType='M6', l=25.0):
        ...
        if (SType == 'DIN967'):
            ...
            # Head Points
            Pnt0 = Base.Vector(0.0, 0.0, k)
            PntArc = Base.Vector(rf * math.sin(alpha / 2.0), 0.0, k -
                                 rf + rf * math.cos(alpha / 2.0))  # arc-point of button
            Pnt1 = Base.Vector(rf * math.sin(alpha), 0.0,
                               c)  # end of button arc
            ...
            if (SType == 'ISO7380-1'):
                P, b, a, da, dk, dk_mean, s_mean, t_min, r, k, e, w = iso7380def[
                    ThreadType]
                ...
                ak = -(4 * k**2 + e_cham**2 - dk**2) / \
                    (8 * k)  # helper value for button arc
                rH = math.sqrt((dk / 2.0)**2 + ak**2)  # radius of button arc
                alpha = (math.atan(2 * (k + ak) / e_cham) +
                         math.atan((2 * ak) / dk)) / 2

                # arc-point of button
                Pnt2 = Base.Vector(rH * math.cos(alpha),
                                   0.0, -ak + rH * math.sin(alpha))
            ...
            if (SType == 'ISO7380-2'):
                P, b, c, da, dk, dk_c, s_mean, t_min, r, k, e, w = iso7380_2def[
                    ThreadType]
                ...
                ak = -(4 * (k - c)**2 + e_cham**2 - dk**2) / \
                    (8 * (k - c))  # helper value for button arc
                rH = math.sqrt((dk / 2.0)**2 + ak**2)  # radius of button arc
                alpha = (math.atan(2 * (k - c + ak) / e_cham) +
                         math.atan((2 * ak) / dk)) / 2

                # arc-point of button
                Pnt2 = Base.Vector(rH * math.cos(alpha), 0.0,
                ...
                PntC2 = Base.Vector((dk_c - c) / 2.0, 0.0,
                                    0.0)  # collar points
            ...
            # Head Points
            # Center Point for chamfer
            Pnt0 = Base.Vector(e_cham / 4.0, 0.0, k - e_cham / 4.0)
            # inner chamfer edge at head
            Pnt1 = Base.Vector(e_cham / 2.0, 0.0, k)
            # Points for recessShell cutter
    ...
    def makeShellthread(self, d, P, halfrots, withcham, offSet):
        ...
        # helix = Part.makeHelix(P,P,d*511/1000.0,0) # make just one turn,
        # length is identical to pitch
        # make just one turn, length is identical to pitch
        helix = Part.makeHelix(P, P, d * self.Tuner / 1000.0, 0)
        ...
        edge1 = Part.Arc(FreeCAD.Vector(ps1), FreeCAD.Vector(
            ps2), FreeCAD.Vector(ps3)).toShape()
        ...
        edgec2 = Part.Arc(FreeCAD.Vector(pc2), FreeCAD.Vector(
            pc3), FreeCAD.Vector(pc4)).toShape()
        ...
        angled_Helix = Part.makeHelix(
            Hyp, Hyp * 1.002 / 2.0, d * tuning, alpha)

        SH_faces = []

        if halfturn:
            half_Helix = Part.makeHelix(
                P, P / 2.0, d * self.Tuner / 1000.0, 0)  # make just half a turn
            angled_Helix.rotate(Base.Vector(0, 0, 0),
                                Base.Vector(0, 0, 1), 180)
            angled_Helix.translate(FreeCAD.Vector(0.0, 0.0, P / 2.0))
            # Part.show(half_Helix)
            # Part.show(angled_Helix)
            pipe_cut = Part.Wire([half_Helix, angled_Helix]).makePipeShell(
                [cut_profile], True, isFrenet)
            ...
            pipe_cut = Part.Wire(angled_Helix).makePipeShell(
                [cut_profile], True, isFrenet)
            SH_faces.append(pipe_cut.Faces[0])
            SH_faces.append(pipe_cut.Faces[1])
            SH_faces.append(pipe_cut.Faces[2])
        ...
        rect_helix = Part.Wire(helix).makePipeShell(
            [rect_profile], True, isFrenet)
        # if halfturn:
        ...
        rect_ring = rect_Face.revolve(Base.Vector(
            0.0, 0.0, 0.0), Base.Vector(0.0, 0.0, 1.0), 360)
        # Part.show(rect_ring)
        ...
        shell_ring = edge_r9.revolve(Base.Vector(
            0.0, 0.0, 0.0), Base.Vector(0.0, 0.0, 1.0), 360)
        ...
        if withcham:
            ...
            pch2 = (r + cham_off, 0.0, -(rotations)
                    * P + cham_t + cham_off + bot_off)
            ...
            cham_Solid = cham_Face.revolve(Base.Vector(
                0.0, 0.0, -(rotations - 1) * P), Base.Vector(0.0, 0.0, 1.0), 360)
    ...
    '''
        ...
        # print self.Tuner, " ", TheShell.ShapeType, " ", TheShell.isValid(), "
        # hrots: ", halfrots_int, " Shellpunkte: ", len(TheShell.Vertexes)
    ...
    def makeInnerThread_2(self, d, P, rotations, da, l):
        ...
        edge3 = Part.Arc(FreeCAD.Vector(ps3), FreeCAD.Vector(
            ps4), FreeCAD.Vector(ps5)).toShape()
        edge4 = Part.makeLine(ps5, ps6)
        edge5 = Part.makeLine(ps6, ps7)
        edge6 = Part.makeLine(ps7, ps0)
        ...
        if da is not None:
            ...
            # points for chamfer: common-Method
            pch0 = (da / 2.0 - cham_i_delta, 0.0, -
                    cham_i - offSet)  # bottom chamfer
            ...
            commonbox.translate(
                FreeCAD.Vector(-(d + 4.0 * P) / 2.0, -(d + 4.0 * P) / 2.0, -2.0 * P))
            # Part.show(commonbox)
        ...
        if da is not None:
            # points for chamfer: common-Method
            pch0 = (da / 2.0 - cham_i_delta, 0.0, -
                    (rotations) * P + cham_i)  # bottom chamfer
            ...
            BotShell = Part.Shell(botFaces)
            # Part.show(BotShell)
            chamFcutter.translate(FreeCAD.Vector(
            ...
            # print self.Tuner, " ", TheShell.ShapeType, " ",
            # TheShell.isValid(), " hrots: ", halfrots_int, " Shellpunkte: ",
            # len(TheShell.Vertexes)
    ...
    def makeIso4032(self, SType='ISO4032', ThreadType='M6'):
        ...
        if self.rThread:
            Pnt0 = Base.Vector(da / 2.0 - 2.0 * cham_i_delta,
                               0.0, m - 2.0 * cham_i)
            Pnt7 = Base.Vector(da / 2.0 - 2.0 * cham_i_delta,
                               0.0, 0.0 + 2.0 * cham_i)
        else:
        ...
        aWire = Part.Wire([edge0, edge1, edge2, edge3,
    ...
    def makeEN1661(self, ThreadType='M8'):
        ...
        PntC4 = Base.Vector(s / math.sqrt(3.0) + chamHori,
                            0.0, m - cham - cham)  # s/math.sqrt(3.0)
        edgeC1 = Part.makeLine(PntC3, PntC1)
        edgeC2 = Part.makeLine(PntC1, PntC2)
        edgeC3 = Part.makeLine(PntC2, PntC4)
        edgeC4 = Part.makeLine(PntC4, PntC3)
        ...
        Pnt3 = Base.Vector(dc / 2.0, 0.0, c / 2.0)
        Pnt4 = Base.Vector((dc - c) / 2.0, 0.0, 0.0)
        # start of fillet between flat and thread
        Pnt5 = Base.Vector(da / 2.0, 0.0, 0.0)
    ...
    def cutChamfer(self, dia_cC, P_cC, l_cC):
        ...
        PntC2 = Base.Vector(dia_cC / 2.0 + cham_t,
                            0.0, -l_cC + cham_t + cham_t)
        ...
        # Part.show(CWire)
        CFace = Part.Face(CWire)
        cyl = CFace.revolve(Base.Vector(0.0, 0.0, 0.0),
                            Base.Vector(0.0, 0.0, 1.0), 360)
        return cyl

    # cross recess type H
    def makeCross_H3(self, CrossType='2', m=6.9, h=0.0):
        # m = diameter of cross at top of screw at reference level for
        # penetration depth
    ...
    def makeAllen2(self, s_a=3.0, t_a=1.5, h_a=2.0):
        ...
        # Part.show(hWire)
        hFace = Part.Face(hWire)
        roundtool = hFace.revolve(Base.Vector(
            0.0, 0.0, 0.0), Base.Vector(0.0, 0.0, 1.0), 360)
        ...
        hexagon = Part.makePolygon(polygon)
        hexFace = Part.Face(hexagon)
        solidHex = hexFace.extrude(Base.Vector(
            0.0, 0.0, -1.0 - t_a - depth * 1.1))
    ...
    def makeIso10664_3(self, RType='T20', t_hl=3.0, h_hl=0):
        ...
        cutShell = hWire.revolve(Base.Vector(
            0.0, 0.0, 0.0), Base.Vector(0.0, 0.0, 1.0), 360)
