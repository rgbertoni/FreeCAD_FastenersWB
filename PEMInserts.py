...
CLSDiamCodes = ['Auto', 'M2', 'M2.5', 'M3',
                'M3.5', 'M4', 'M5', 'M6', 'M8', 'M10', 'M12']
CLSPEMTable = {
    #         (00,   0,    1,    2   )  C,     E,     T,    d
...
class FSPressNutObject(FSBaseObject):
    ...
    def __init__(self, obj, attachTo):
        ...
        obj.addProperty("App::PropertyEnumeration", "tcode",
                        "Parameters", "Thickness code").tcode = CLSSizeCodes
        obj.addProperty("App::PropertyEnumeration", "diameter", "Parameters",
                        "Press nut thread diameter").diameter = CLSDiamCodes
...
SOLengths = {'3': 0, '4': 0, '6': 0, '8': 0, '10': 4, '12': 4,
             '14': 4, '16': 8, '18': 8, '20': 8, '22': 11, '25': 11}
...
class FSStandOffObject(FSBaseObject):
    ...
    def __init__(self, obj, attachTo):
        ...
        obj.addProperty("App::PropertyEnumeration", "diameter", "Parameters",
                        "Standoff thread diameter").diameter = SODiameters
        obj.addProperty("App::PropertyBool", "blind",
                        "Parameters", "Blind Standoff type").blind = False
        obj.addProperty("App::PropertyEnumeration", "length", "Parameters",
                        "Standoff length").length = soGetAllLengths(SODiameters[1], False)
        obj.invert = FastenerBase.FSLastInvert
        obj.Proxy = self
...
class FSStudObject(FSBaseObject):
    ...
    def __init__(self, obj, attachTo):
        ...
        obj.addProperty("App::PropertyEnumeration", "length", "Parameters",
                        "Standoff length").length = fhGetAllLengths(FHDiameters[1])
        obj.invert = FastenerBase.FSLastInvert
        obj.Proxy = self
